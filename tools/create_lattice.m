...
for height = planning_parameters.min_height: ...
    ...
    [grid_x, grid_y] = meshgrid(linspace(half_submap_edge_size_x, map_parameters.dim_x-half_submap_edge_size_x, ceil(sqrt(num_of_points))), ...
                        linspace(half_submap_edge_size_y, map_parameters.dim_y-half_submap_edge_size_y, ceil(sqrt(num_of_points))));
